...
check contents of stack size

compute whther stack is too full or isnt full enough
return overflown contents to top
print "expression is too complex" and exit
print "Not enough operands in expression" and exit
